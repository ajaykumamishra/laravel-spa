...
class EventController extends Controller
{
    ...
    public function index_data(){
        $module_name = Event::with('eventAddress')->get();
        $data = $module_name;
        return DataTables::of($module_name)
        ->addColumn('address', function ($data){
            return "ff";
            function findCountry($id){
                return Country::where('id',$id)->select('id','name')->first();
            }
            function findState($id){
                return State::where('id',$id)->select('id','name')->first();
            }
            function findCity($id){
                return City::where('id',$id)->select('id','name')->first();
            }
